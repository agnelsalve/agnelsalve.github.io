...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Agnel Salve";
...
var typed = new Typed(".typing-text", {
    strings: ["data analytics", "data engineering", "data science", "business intelligience", "cloud solution architect"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showProjects(projects) {
    ...
    let projectHTML = "";
    // show top 6 projects on the homepage (exclude android category)
